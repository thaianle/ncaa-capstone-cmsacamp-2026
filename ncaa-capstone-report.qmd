...
When it comes to the data used in our research, we used the `hoopR` R package part of the **SportsDataverse** ecosystem. Within this dataset, each observation is a player's season and their metrics for that season. This datasource is also publically available, making our code (link found under Contact Information and Code Availability section) entirely reproducible. 

![](hoopR logo.png){fig-align="center" width="186"}
...
##### Conferences with the most transfers in and out

![](in_and_out.png){width="592"}
...
>>>>>>> 25ec045ea8c5e7fbe6c34bbacd06ece19d51dd84
