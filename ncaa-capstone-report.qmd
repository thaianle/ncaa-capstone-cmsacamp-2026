...
>>>>>>> e856b6b65492c8c7ec148d9cf6162655ba11bf35
...
This research provides multiple understandings on the relationship between transferring and a player's athletic performance. When analyzing this relationship on all transfer athletes, an insignificant effect on a player's points per game after transferring was found in all 3 models. However, when it comes to grouping players into overperformers and underperformers based on their performance relative to their teammates, the significant results lie in this distinction. These results support the previous findings that transferring as an underperformer is associated with increases in points per game, while transferring for overperformers is associated with significant decreases in points per game. 

Firstly, the results of this study impact players in NCAA Division I Men's Basketball. A player, before transferring, may want to look into their performance relative to their team, and assess their status as either an underperformer or overperformer within their respective program. This is because underperformers who transfer will find more success than underperformers who stay at their current school. In fact, previous underperforming transfers will score around 2 more points per game compared to a similar player that does not transfer. Reversely, as an overperformer at their current program, upon transferring, players experience a 1.5 point per game drop compared to overperforming players that do not transfer between years. So, overperformers may want to rethink the decision of transferring before fully committing to a different school, while underperformers may put more thought on the decision to stay.

From a coach's perspective, a similar framework can be applied on finding players from the portal to invest in. The more successful players after a transfer occurs, will come from underperformers, potentially from higher ranked schools. For example, a coach may attempt to find a replacement for a player already on the roster. If a replacement player comes from an underperforming background and has a similar propensity score to a player already on the roster, that replacement player would be projected to score 2 more points per game than the existing player, as that existing player would be staying at the same school. Conversely, it is expected that a transfer player coming as an overperformer will obtain around 1.5 points per game less than a similar player who stays. So, while scouting overperforming and players finding success in the transfer portal is enticing, that particular choice in players is unlikely to result in an improved performance.

A major takeaway from these findings is the importance of finding a competition level where the player can maximize their potential. Different conferences within the NCAA are like their own miniature leagues with their own competition level. This gives players the unique ability to find the niche environment to perform their best, and transferring gives players the ability to do exactly this. Of course, with the always-changing makeup of the modern NCAA, the need for further analysis persists.
